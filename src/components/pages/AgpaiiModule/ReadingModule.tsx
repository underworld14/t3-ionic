          ...
          <div className="mx-auto w-full max-w-screen-md">
            <div className="space-y-3 px-4 pt-5">
              ...
              <p className="text-justify text-[13px]">
                ...
                pandangan Islam adalah tempat menanam (mazra‟ah) yang hasilnya akan diunduh di
                akhirat kelak.
              </p>
              <p className="text-justify text-[13px]">
              ...
              <p className="text-justify text-[13px]">
                ...
                prinsip-prinsip agama lain, seperti mengesakan Allah di bidang akidah dan salat
                serta puasa dan lainnya di bidang ibadah, hanya berbeda cara pelaksanaannya. Inilah
                keistimewaan Islam yang diturunkan kepada Nabi Muhammad SAW yang sangat terbuka
                untuk seluruh umat manusia tanpa membedakan warna kulit, bangsa dan profesi.{' '}
              </p>
              <p className="text-justify text-[13px]">
