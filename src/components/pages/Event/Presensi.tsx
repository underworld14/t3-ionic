      ...
      <IonContent>
        <div className="mt-[75px]">
          <div className="mx-auto w-full max-w-screen-md">
            <IonModal
              className="mx-3 my-auto h-44 rounded-lg"
              id="example-modal"
              ref={modal}
              ...
              <div className="wrapper px-3 py-2">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex w-full justify-end gap-2 ">
                    <Button className="bg-tertiary px-6 py-2 text-black" onClick={dismiss}>
                      Nanti
                    </Button>
                    <Button className="bg-primary px-6 py-2 text-white" onClick={dismiss}>
                      Oke
                    </Button>
                  </div>
                </div>
