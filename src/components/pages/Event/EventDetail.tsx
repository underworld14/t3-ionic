              ...
              <IonContent>
                ...
                <div className="absolute mx-4 mt-[72px]">
                  ...
                  <h2 className="mt-2 text-lg font-semibold">
                    Rapat akhir bulan bersama guru agama
                  </h2>
                  ...
                  <div className="mt-4 px-5">
                    ...
                    <p className="mt-2 text-tertiary">
                      Deskripsi acara Deskripsi acara Deskripsi acara Deskripsi acara Deskripsi
                      acara Deskripsi acara Deskripsi acara Deskripsi acara Deskripsi acara
                      Deskripsi acara Deskripsi acara Deskripsi acara Deskripsi acara Deskripsi
                      acara Deskripsi acara
                    </p>
                  </div>
                </div>
              </IonContent>
